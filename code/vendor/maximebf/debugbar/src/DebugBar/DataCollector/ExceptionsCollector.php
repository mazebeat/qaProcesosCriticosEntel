...
class ExceptionsCollector extends DataCollector implements Renderable
{
	...
	{
		return array('count'      => count($this->exceptions),
	...
	{
		return array('exceptions'       => array('icon'    => 'bug',
		                                         'widget'  => 'PhpDebugBar.Widgets.ExceptionsWidget',
		                                         'map'     => 'exceptions.exceptions',
		                                         'default' => '[]'),
		             'exceptions:badge' => array('map'     => 'exceptions.count',
		                                         'default' => 'null'));
	}
}
