...
class FeatureContext extends BehatContext
{
	...
	public function iGenerateAMigrationWithNameAndFields($migrationName, $fields)
	{
		...
		$this->tester->execute(['migrationName'  => $migrationName,
		                        '--fields'       => $fields,
		                        '--testing'      => true,
		                        '--path'         => __DIR__ . '/../../tmp',
	...
	public function iGenerateAModelWith($modelName)
	{
		...
		$this->tester->execute(['modelName'      => $modelName,
		                        '--path'         => __DIR__ . '/../../tmp',
	...
	public function iGenerateAControllerWith($controllerName)
	{
		...
		$this->tester->execute(['controllerName' => $controllerName,
		                        '--path'         => __DIR__ . '/../../tmp',
	...
	public function iGenerateAViewWith($viewName)
	{
		...
		$this->tester->execute(['viewName'       => $viewName,
		                        '--path'         => __DIR__ . '/../../tmp',
