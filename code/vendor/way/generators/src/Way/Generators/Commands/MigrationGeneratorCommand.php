...
class MigrationGeneratorCommand extends GeneratorCommand
{
	...
	protected function getTemplateData()
	{
		...
		return ['CLASS' => ucwords(camel_case($migrationName)),
	...
	{
		return array(array('migrationName', InputArgument::REQUIRED, 'The migration name'));
	}
	...
	{
		return array(['fields', null, InputOption::VALUE_OPTIONAL, 'Fields for the migration'],
