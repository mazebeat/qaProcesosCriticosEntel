...
class PivotGeneratorCommand extends Command
{
	...
	public function fire()
	{
		...
		$this->call('generate:migration', ['migrationName' => "create_{$tableOne}_{$tableTwo}_table",
	...
	{
		return implode(', ', ["{$tableOne}_id:integer:unsigned:index",
	...
	{
		return [['tableOne', InputArgument::REQUIRED, 'Name of the first table'],
