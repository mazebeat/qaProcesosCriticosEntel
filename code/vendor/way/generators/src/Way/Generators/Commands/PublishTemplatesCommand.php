...
class PublishTemplatesCommand extends Command
{
	...
	public function fire()
	{
		...
		$this->info("The templates have been copied to '{$this->option('path')}'. " . "Modify these templates however you wish, and they'll be referenced " . "when you execute the associated generator command.");
	}
	...
	protected function copyTemplatesDirectoryForEditing()
	{
		...
		// them how they wish.
		File::copyDirectory(__DIR__ . '/../templates', $this->option('path'));
	}
