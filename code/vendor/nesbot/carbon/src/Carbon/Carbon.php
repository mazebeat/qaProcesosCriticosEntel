...
class Carbon extends DateTime
{
	 ...
	 * @var array
	 */
	protected static $days = array(self::SUNDAY    => 'Sunday',
	                               self::MONDAY    => 'Monday',
	 ...
	 * @var array
	 */
	protected static $relativeKeywords = array('this',
		'next',
		'last',
		'tomorrow',
		'yesterday',
	...
	public function diffForHumans(Carbon $other = null)
	{
		...
		$divs = array('second' => self::SECONDS_PER_MINUTE,
