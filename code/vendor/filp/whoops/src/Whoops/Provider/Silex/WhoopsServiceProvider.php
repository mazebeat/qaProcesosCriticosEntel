	...
	public function register(Application $app)
	{
		...
		$app['whoops.silex_info_handler'] = $app->protect(function () use ($app) {
			...
			if ($errorPageHandler instanceof PrettyPageHandler) {
				...
				$errorPageHandler->addDataTable('Silex Application', array('Charset'           => $app['charset'],
				                                                           'Locale'            => $app['locale'],
				...
				// Request info:
				$errorPageHandler->addDataTable('Silex Application (Request)', array('URI'          => $request->getUri(),
