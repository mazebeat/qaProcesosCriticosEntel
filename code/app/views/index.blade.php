...
@section('content')
	<div ng-controller="homeController">
		...
		<form class="form-signin" name="loginForm" ng-submit="validUser()">
			...
			<div class="alert alert-warning alert-dismissible" role="alert" ng-show="!errors.valid">
			...
			<div class="login-wrap">
				<input type="text" name="username" id="username" ng-model="user.username" class="form-control ng-dirty ng-invalid" placeholder="Usuario" required>
				...
				<button type="submit" ng-disabled="loginForm.$invalid" id="loginFormButton" class="btn btn-lg btn-login btn-block ladda-button" data-style="zoom-in" data-size="s">
					<span class="ladda-label"><i class="fa fa-check"></i></span>
				</button>
				<div class="registration">
					<label class="text-center"> <a data-toggle="modal" href="#forgotPasswordModal">Olvidaste tu contraseña?</a> </label>
				</div>
			</div>
			...
			<div>
				...
				</a> <a class="pull-right" href="http://www.intersoft-sa.com/" target="_blank">
